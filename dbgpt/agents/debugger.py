...
class PostgresDBExplorer(BaseTool):
    ...
    def _run(
        ...
        self._cursor.execute("SET statement_timeout = 5000; EXPLAIN ANALYZE " + self._query)
        result = ""
...
class DebuggingAgent:
    def __init__ (self, query, cursor, fast_plan, slow_plan):
        ...
        Try out different knobs and parameters, like optimization related (e.g. strategies), etc. You can try creating
        indexes too.
        """
